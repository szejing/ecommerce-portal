	...
	<div class="w-full">
		...
		<div class="grid grid-cols-3 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-3">
			...
			<div class="flex flex-col col-span-3 sm:col-span-2 gap-1.5">
				...
				<UInput v-model="filter.query" placeholder="Search tag..." :icon="ICONS.SEARCH_ROUNDED" @input="debouncedSearch" />
			</div>
...
const { filter } = storeToRefs(productTagStore);

const is_loading = computed(() => productTagStore.loading);
