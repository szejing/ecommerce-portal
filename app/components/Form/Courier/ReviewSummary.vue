<template>
	<UCard id="section-courier-review" class="shadow-lg border border-primary-200/60 rounded-xl overflow-hidden scroll-mt-4">
		<template #header>
...
withDefaults(
	defineProps<{
		summary: CourierReviewSummary;
		subtitleKey?: string;
	}>(),
	{ subtitleKey: 'components.courierForm.reviewSubtitleEdit' },
);
</script>
